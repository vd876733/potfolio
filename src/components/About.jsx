...
export default function About() {
  ...
  return (
    <div className="w-full bg-[#faf6ee] dark:bg-charcoal text-slate-800 dark:text-[#e2e8f0] p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200/60 dark:border-purple-500/5 transition-colors duration-300 flex flex-col gap-6">
