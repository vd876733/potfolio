...
export default function About() {
  ...
  return (
    <div className="w-full bg-[#faf6ee] dark:bg-slate-900 text-slate-800 dark:text-slate-100 p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200/60 dark:border-slate-800 transition-colors duration-300 flex flex-col gap-6">
      ...
      <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3 pt-4 border-t border-slate-100 dark:border-slate-800">
